...
## CI/CD Setup
This project is up and running on GitHub Pages, thanks to the smooth CI/CD setup. Just push a commit to the main branch, and after a successful build, you can visit the page via [https://eydamson-dev.github.io/orchard/](https://eydamson-dev.github.io/orchard/) 🌟
